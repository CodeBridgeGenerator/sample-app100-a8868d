...
const skuArray = ["A","B","C","D"];
const skuOptions = skuArray.map((x) => ({ name: x, value: x }));
...
<div className="col-12 md:col-6 field">
            <span className="align-items-center">
                ...
                <Dropdown id="sku" value={_entity?.sku} options={skuOptions} optionLabel="name" optionValue="value" onChange={(e) => setValByKey("sku", e.value)}  />
            </span>
            <small className="p-error">
            {!_.isEmpty(error["sku"]) ? (
