...
const dropdownArrayTemplate1 = (rowData, { rowIndex }) => <p >{rowData.sku}</p>
...
<Column field="sku" header="Sku" body={dropdownArrayTemplate1} filter={selectedFilterFields.includes("sku")} hidden={selectedHideFields?.includes("sku")}  style={{ minWidth: "8rem" }} />
